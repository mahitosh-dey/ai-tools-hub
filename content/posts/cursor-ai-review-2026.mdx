...
coverImagePrompt: "Dark cinematic 16:9 image of a developer's desk at night: a laptop screen glowing with abstract flowing code in purple/cyan, a neural mesh overlay above the code, subtle floating cursor icon, holographic terminal windows in the background, no text, moody atmospheric lighting."
