...
excerpt: "Every comparison pits Midjourney against Stable Diffusion, whose reference repo has not been touched since January 2025. Meanwhile the model everyone recommends as the free alternative is licensed for non-commercial use only, and its GitHub page says Apache-2.0."
