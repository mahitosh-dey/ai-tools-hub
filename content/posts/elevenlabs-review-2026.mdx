...
excerpt: "What ElevenLabs actually does well, what the pricing adds up to, how it compares with Murf, Descript and OpenAI TTS, and who needs the paid tiers."
category: "Reviews"
tags:
  - "elevenlabs"
  - "ai-tools"
...
faqs:
  ...
  - q: "What are the main ElevenLabs alternatives?"
    a: "The closest live alternatives are Murf AI, Descript, and self-hosted Chatterbox. Check any list you read against reality first: Play.ht shut down on December 31, 2025 after Meta acqui-hired the team, and its domain no longer resolves, while LOVO filed for Chapter 7 bankruptcy in May 2026. Both still appear in alternatives round-ups published this year. ElevenLabs generally produces more natural results than Murf or Descript but costs more. OpenAI's TTS API is cheaper for developers building apps but offers no voice cloning and fewer voice options."
...
Prices, credit allowances, and voice model names in this review were re-verified against elevenlabs.io on 2026-09-14. Every tier price and credit allowance below held unchanged from the 2026-08-03 and 2026-07-29 checks. The credit rollover policy did not hold: this review had it backwards, and that is corrected below. Competitor availability was checked the same day by resolving each domain. ElevenLabs revises pricing periodically, so check elevenlabs.io for current numbers before subscribing.
...
Verified against elevenlabs.io on 2026-09-14. Two things changed since this review first published, and both are worth flagging because older guides (including an earlier version of this one) still carry the old numbers.
...
Unused credits do roll over, for up to two months. Your balance can reach at most three times your monthly quota, and that survives only while the subscription stays active and you have not downgraded or cancelled. Rollover does not apply to the Free plan, and pay-as-you-go top-up credits sit outside the cap entirely.

This review said the opposite until today. It read "unused credits do not roll over," which is wrong against both [elevenlabs.io/pricing](https://elevenlabs.io/pricing) and ElevenLabs' own help article on [how credit rollover works](https://help.elevenlabs.io/hc/en-us/articles/27561768104081-How-does-credit-rollover-work). My own [ElevenLabs alternatives](/blog/best-elevenlabs-alternatives) post had it right, so for a while these two pages contradicted each other about the same vendor's money. That is worse than either page being wrong alone, and it is fixed here rather than quietly.

Check elevenlabs.io before subscribing, because this table has already gone stale once. That is not unique to ElevenLabs either. I logged every major [AI pricing change in 2026](/blog/ai-pricing-changes-2026) with dates, and the pattern of prices holding steady while the product behind them shifts turns out to be the story of the whole year.
...
I have left this section here rather than quietly deleting it, because Play.ht still appears in most "best AI voice generator" lists published this year, including ones dated after it died. If you arrived looking for it, that is why you could not find it. I resolved every domain in those lists and wrote up what is actually still running in [best ElevenLabs alternatives](/blog/best-elevenlabs-alternatives), where Play.ht is not the only dead entry.

### ElevenLabs vs Chatterbox (self-hosted)

**Chatterbox** is the option ElevenLabs comparisons skip, because nobody earns a commission recommending it. It is an open-source TTS model from Resemble AI under the MIT license, with zero-shot voice cloning and inline emotion tags. Reading the repository through the GitHub API on September 14, 2026: 26,407 stars, MIT licensed, not archived, with the most recent commit dated July 21, 2026. That commit date has not moved in eight weeks, so "actively maintained" is doing less work than it was when I first wrote it, though a mature model repository going quiet for two months is not the same signal as a hosted service going quiet. Most articles quoting star counts for it are working from numbers less than half that.
...
**Murf AI** (Creator $29/month, Business $99/month, or $19 and $66 if you pay annually) is aimed more at corporate voiceovers than creative content. Their studio is easy to use and their voices sound polished in a business-narration way. The catch: fewer natural conversational voices, and voice cloning is more limited than ElevenLabs. For explainer videos and internal training content, Murf is competent. For anything where you want the voice to sound like a person talking, ElevenLabs is a clear step up.

A note on those Murf numbers, because I got them wrong here before. This review previously listed Murf at "$19 to $79/month". The $19 is the annual-billing rate printed as though it were the monthly one, and $79 did not match any tier. Murf's pricing page renders entirely in JavaScript and serves a six-kilobyte shell with no prices in it to anything that is not a browser, which is how the error survived. Confirm the current figures in a real browser on murf.ai/pricing before you budget against them.
