...
rechecking this post and could not find one, so they are gone. What is sourced: a
February 2026 paper, Towards a Science of AI Agent Reliability, evaluated 14 models
and found recent capability gains produced only small reliability gains. Current
benchmarks put leading models at 80 to 90 percent on single-turn tasks and roughly
18 to 24 percent on sustained multi-step workflows that cross applications.
