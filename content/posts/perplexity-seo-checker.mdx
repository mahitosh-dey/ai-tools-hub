...
excerpt: "Every Perplexity SEO checker article is written by someone selling a Perplexity SEO checker. This one is written by a publisher with real citation data, re-measured: 108 AI citations in a week across 5 pages, up from 34 across 1 page a fortnight earlier. Here is how to check yours for free and what the paid tools actually add."
category: "Guides"
tags:
  - "seo"
  - "perplexity-ai"
...
I have re-measured this since first publishing, and the numbers moved enough that the original finding no longer holds.

On July 29, 2026 I had 31 posts and Bing reported 34 AI citations across the previous week, every one of them pointing at a single page. On August 14 I checked again: 38 posts, and **108 citations in seven days across 5 different pages**.

Citations roughly tripled in a fortnight, and the number of pages earning them went from one to five. Bing's three-month total is 199, which means **more than half of every citation this site has ever received arrived in the last seven days**.

I am leading with that because it is the opposite of what most articles in this category do. The first version of this post built an argument on a single cited page. That argument is now standing on different ground, and pretending otherwise would make me exactly the kind of source I complained about at the top.
...
The original single-page outlier was my [guide to the best free AI image generators](/blog/best-free-ai-image-generators), which earned every one of the first 34. It is no longer alone.

One honest limitation on the newer number: I can see that five pages are being cited, and I have not yet broken out which five or how the 108 distributes across them. Until I have, treat what follows as a hypothesis that survived its first real test rather than one that has been confirmed.
...
When I first wrote this, that analysis rested on exactly one page, and I said so: a hypothesis worth testing, not a law.

Two weeks later there are five cited pages and three times the citations, which is the first real test it has had. The honest reading is that the theory survived, because the site did not gain authority in a fortnight and nothing else obvious changed. What did change is that I have spent that fortnight rewriting posts to answer questions directly in labelled sections, largely for readers rather than for machines. If extraction-friendly structure is what earns citations, that is roughly the intervention you would run.

I want to be careful not to overclaim on the back of that. Correlation on a sample of one site is thin evidence, the acceleration could have causes I cannot see, and I have not yet confirmed which five pages are being cited, which is the check that would actually test it. What makes it worth acting on anyway is that the cost is close to zero: restructuring headings is an afternoon of work with no downside if the theory is wrong, because clearer headings serve human readers regardless.
