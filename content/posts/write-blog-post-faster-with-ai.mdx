...
- **ChatGPT free tier** — for outlines and section drafting
- **Claude free tier** — a strong alternative, especially for longer posts
- **Perplexity AI** — for research with cited sources
- **Grammarly free tier** — for editing and error-catching
