...
faqs:
  ...
  - q: "What does the Claude 5 family cost on the API?"
    a: "Read against Anthropic's model reference on August 4, 2026, per million tokens input and output: Claude Fable 5 is $10 and $50, Claude Opus 5 is $5 and $25, Claude Sonnet 5 is $2 and $10, and Claude Haiku 4.5 is $1 and $5. One correction there: this page previously said Sonnet 5 was $3 and $15 with an introductory rate expiring on August 31, 2026. I re-checked on September 1 and Anthropic still lists $2 and $10 with no introductory label anywhere on the page, so the $3 figure has been removed rather than promoted. Context windows are 1 million tokens on everything except Haiku 4.5, which is 200,000."
