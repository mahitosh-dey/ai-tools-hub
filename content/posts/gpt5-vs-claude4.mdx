...
**Image generation.** Claude reads images and PDFs but does not appear to generate them: Anthropic's capability documentation lists image input with no image output counterpart. If generation is part of your workflow, that is ChatGPT or a specialist tool. My [Midjourney vs DALL-E 3](/blog/midjourney-vs-dalle3) comparison covers the dedicated options.
