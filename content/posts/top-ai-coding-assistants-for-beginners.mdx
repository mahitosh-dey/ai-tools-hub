...
faqs:
  ...
  - q: "Is GitHub Copilot's free tier enough for someone learning to code?"
    a: "Just about. The free tier gives 2,000 code completions per month plus limited chat and agent usage, which covers a beginner working on one or two small projects. You will hit the ceiling in a heavy weekend of coding. Pro at $10 per month gives you genuinely unlimited code completion, but read the next part carefully because it changed in 2026: chat, agents, and CLI now draw from a monthly AI credit allowance rather than being unlimited. Pro includes $15 of credits per month, where 1 credit equals $0.01. Students with a verified GitHub account get Pro free through the GitHub Student Developer Pack, which is still the best deal in this category."
  - q: "Should I start with the free version of Windsurf?"
    a: "You cannot. Windsurf no longer exists under that name. Cognition acquired it and folded it into the Devin product line, and both windsurf.com and codeium.com now redirect to devin.ai/desktop. Earlier versions of this post recommended starting with Windsurf at $15 a month, which was true when written and is now wrong twice over: the name is gone and the individual plan is $20, the same as Cursor. If you want a free editor to learn in, use Cursor's Hobby tier or VS Code with GitHub Copilot Free."
...
**Cursor and Devin Desktop: one to two weeks.** These are full editors with agent modes, multi-file editing, and their own conventions layered on top of everything VS Code already asks of you. Genuinely powerful, and genuinely the wrong first tool. Most beginners who start here spend their first fortnight learning keyboard shortcuts instead of programming.

The practical rule: **for your first three to six months, pick the tool with the shallowest learning curve, not the most capability.** Claude or ChatGPT in a browser, with code you type yourself into a plain editor. Move to Copilot when autocomplete would genuinely save you time. Move to Cursor only when you can read a diff and say confidently whether it is right. Our [full walkthrough of Claude for coding](/blog/how-to-use-claude-ai-for-coding) covers that first-six-months workflow, and the [Cursor review](/blog/cursor-ai-review-2026) explains what you are graduating into later.
...
**Website:** chatgpt.com
**Free tier:** Yes, and it now includes image generation, voice and memory
**Paid:** Go at $8/month, Plus at $20/month, Pro at $100 or $200/month
...
The main difference from Claude has narrowed. Both now have image or code output, voice, and memory on their free tiers, and the models are close enough for beginner coding work that neither will hold you back. The choice between them for beginners often comes down to personal preference after a few sessions with each.
...
**Free tier:** Yes, Copilot Free (2,000 code completions/month, limited chat and agent usage)
**Paid:** Pro at $10/month, Pro+ at $39/month, Max at $100/month. Business and Enterprise exist but GitHub's plans page no longer prints a price for either and points to contact sales, so ignore the $19 and $39 figures still circulating
**Billing change:** Since June 1, 2026 the paid plans include a monthly AI credit allowance ($15 on Pro, $70 on Pro+, $200 on Max, where 1 credit equals $0.01). Code completion stays unlimited. Chat, agents, code review, and CLI draw from credits.
**Students:** Free via GitHub Student Developer Pack (github.com/education)
...
**Students get Copilot Pro free.** Verify your student status at github.com/education to claim it.
...
**Website:** cursor.com
**Free tier:** Yes, the Hobby plan
**Paid:** Pro at $20/month, Pro+ at $60, Ultra at $200, Teams at $40/user/month
...
**The free Hobby plan** used to be described as 2,000 completions a month. Cursor's current pricing page drops the number and says only "limited Agent requests" and access to Composer, so treat the free tier as enough to evaluate the editor rather than enough to work in. Pro at $20/month is worth it once you are using it daily.
...
## 7. Devin Desktop, which is what Windsurf became

**Website:** devin.ai/desktop
**Free tier:** Yes, with a light quota
**Paid:** Pro at $20/month, Max at $200/month
**Best for:** Developers who wanted Windsurf and need to know where it went

This entry used to recommend Windsurf by Codeium as the best free Cursor alternative at $15 a month, and told beginners to start there. Both halves of that are now wrong, so here is the correction rather than a quiet deletion.

Windsurf no longer exists as a brand. Cognition acquired the company and folded the product into its Devin line. Both `windsurf.com` and `codeium.com` now redirect to `devin.ai/desktop`. Reporting puts the deal at around $250 million in December 2025 with the rebrand in June 2026, and says the individual plan moved from $15 to $20 and swapped credits for daily and weekly quotas at the same time. I checked the redirects myself; the deal figures come from press coverage.

The product did not get worse. What changed is that the reason to pick it did. The entire argument for Windsurf over Cursor was a more generous free tier at a lower paid price. At $20 it is level with Cursor, so a beginner choosing between them is now choosing on feel rather than on cost.

**Recommendation for a beginner:** neither, not yet. If you want an AI-native editor to try, Cursor's Hobby tier costs nothing and has the larger community and more tutorials written against it, which matters more than feature parity when you are stuck at 11pm. Come back to this decision once you are writing code daily.

When you do come back to it, check what is still being maintained before you commit. I looked at the release history of every Cursor competitor in [Cursor alternatives](/blog/cursor-alternatives-2026), and one of the most widely recommended open-source options had not shipped a release in a year.
...
**Free tier:** Yes, but capped at 50 agentic requests a month, not unlimited
**Paid:** Pro at $19/user/month
**Best for:** Developers who work with AWS, individuals who want a generous free tier

Amazon Q Developer (formerly AWS CodeWhisperer) is Amazon's AI coding assistant. Earlier versions of this post called its free tier unlimited. That is wrong, and I am correcting it rather than quietly deleting it: AWS's own pricing page caps the free tier at 50 agentic requests a month, with 1,000 lines of transformation code, and Pro at $19 per user per month raises those limits.
...
It is still worth knowing about, particularly if you work with AWS, where its knowledge of CloudFormation and CDK is genuinely better than the alternatives. But it is not the unlimited free option it is often described as, and 50 agentic requests will not carry a beginner through a weekend project.
...
| ChatGPT | Conversational AI | Yes (images, voice, memory) | $8 Go, $20 Plus | Beginners, general coding Q&A |
| GitHub Copilot | IDE plugin | Yes (2K/month) | $10/month | Developers, inline completion |
| Cursor | AI code editor | Yes (Hobby) | $20/month | Developers, multi-file editing |
...
| Devin Desktop | AI code editor | Yes (light quota) | $20/month | Formerly Windsurf, renamed 2026 |
| Amazon Q Developer | IDE plugin | Yes (50 requests/mo) | $19/month | Developers, AWS work |
...
Add GitHub Copilot Free to VS Code, or Amazon Q Developer if you work with AWS and 50 agentic requests a month is enough. Start writing code yourself with AI autocomplete helping you move faster. Use Claude alongside for questions and for generating larger blocks of code you then modify.

**Month 3 and beyond, regular coding practice.**
Evaluate whether Cursor's multi-file capabilities would help your current projects. Upgrade to paid tiers of the tools you are hitting limits on. Consider whether Bolt.new would speed up specific project types you are building.

The tools in this list are not competitors you pick one from forever. They are a progression. Claude gets you started. Copilot accelerates writing. Cursor scales with more complex projects.

One thing to understand before you start paying for any of them: the subscription is priced below what a working developer actually consumes, and the usage limits are how that arithmetic works for the vendor. That is not a scam, it is how flat pricing always works, but it explains every credit system and cap you will run into. [AI coding agent pricing](/blog/ai-coding-agent-pricing-2026) has the numbers.
